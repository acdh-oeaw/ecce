        ...
        self.layout = Layout(
                Fieldset(
                    ...
                    Div(HTML("""
                        ...
                        data-content='
                        <code style="color: black;"><b>+ld</b></code> finds everything ending with ld<br>
                        <code style="color: black;"><b>ld+</b></code> finds everything starting with ld<br>
                        <code style="color: black;"><b>h+se</b></code> finds everything starting with h and ending with se<br>
                        <code style="color: black;"><b>ld</b></code> finds eveything which contains ld<br>
                        '
