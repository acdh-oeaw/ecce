...
class NormToken(models.Model):
    ...
    label_description = models.CharField(blank=True, null=True, max_length=150)
    ...
    text_meand_date_dates = models.IntegerField(primary_key=True)
    text_meand_date_decade = models.IntegerField(blank=True, null=True)
    text_meand_date_semicentury = models.IntegerField(blank=True, null=True)
    text_meand_date_century = models.IntegerField(blank=True, null=True)
    text_meand_date_pr_cc_checekd = models.FloatField(blank=True, null=True)
    text_meand_date_pr_cc_final = models.FloatField(blank=True, null=True)
    text_meand_date_pr_cc_final_V = models.FloatField(blank=True, null=True)
    text_meand_date_pr_cc_both = models.FloatField(blank=True, null=True)
    text_meand_date_pr_cc_no = models.IntegerField(blank=True, null=True)
    ...
    rightonset_rightonset = models.CharField(blank=True, null=True, max_length=150)
